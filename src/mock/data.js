  ...
  'TSK-20260315-005': [
    {
      ...
      execSteps: [
        { step: '解析券参数', status: 'done', duration: '0.3s' },
        { step: '批量创建草稿', status: 'failed', duration: '1.8s' },
        { step: '校验结果', status: 'pending', duration: null },
        { step: '等待业务确认', status: 'pending', duration: null },
        { step: '确认后提交', status: 'pending', duration: null },
        { step: '结果回传', status: 'pending', duration: null },
      ],
      errors: ['批量创建草稿失败：咖啡品类ID无效，请检查品类配置'],
      ext: {},
      items: [
  ...
  'TSK-20260318-008': [
    {
      ...
      duration: null,
      execSteps: [
        { step: '解析券参数', status: 'done', duration: '0.2s' },
        { step: '批量创建草稿', status: 'running', duration: null },
        { step: '校验结果', status: 'pending', duration: null },
        { step: '等待业务确认', status: 'pending', duration: null },
        { step: '确认后提交', status: 'pending', duration: null },
  ...
  'TSK-20260319-009': [
    {
      ...
      execSteps: [
        { step: '解析券参数', status: 'done', duration: '0.2s' },
        { step: '批量创建草稿', status: 'done', duration: '4.3s' },
        { step: '校验结果', status: 'done', duration: '0.6s' },
  ...
  'TSK-20260320-010': [
    {
      ...
      execSteps: [
        { step: '解析券参数', status: 'done', duration: '0.3s' },
        { step: '批量创建草稿', status: 'done', duration: '2.0s' },
        { step: '校验结果', status: 'done', duration: '0.7s' },
        { step: '等待业务确认', status: 'done', duration: null },
  ...
  'TSK-20260323-013': [
    {
      ...
      execSteps: [
        { step: '解析券参数', status: 'done', duration: '0.3s' },
        { step: '批量创建草稿', status: 'done', duration: '14.0s' },
        { step: '校验结果', status: 'done', duration: '0.6s' },
        { step: '等待业务确认', status: 'running', duration: null },
        { step: '确认后提交', status: 'pending', duration: null },
        { step: '结果回传', status: 'pending', duration: null },
  ...
  'TSK-20260324-014': [
    {
      ...
      execSteps: [
        { step: '解析券参数', status: 'done', duration: '0.3s' },
        { step: '批量创建草稿', status: 'done', duration: '13.5s' },
        { step: '校验结果', status: 'done', duration: '0.6s' },
        { step: '等待业务确认', status: 'done', duration: null },
        { step: '确认后提交', status: 'done', duration: '0.5s' },
        { step: '结果回传', status: 'done', duration: '0.3s' },
